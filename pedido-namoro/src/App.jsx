...
const steps = [
  {
    ...
    locationQuestion: "Em que mês começamos a sair?", // Nova pergunta!
  ...
  },
  {
    ...
    locationQuestion: "O que é horrível, manipulada e só rouba nosso dinheiro?", // Nova pergunta!
  ...
  },
  {
    ...
    locationQuestion: "Está pronta para o que te espera? Digite 'cheguei' para o grand finale.", // Nova pergunta final!
...
export default function TreasureHunt() {
  ...
  const handlePasswordSubmit = () => {
    if (passwordInput.toLowerCase().trim() === currentStepData.locationPassword.toLowerCase()) {
      ...
      setErrorMsg('');
      setShowMap(false);
      setShowFollowUp(false); // Esconde a pergunta para a próxima fase
